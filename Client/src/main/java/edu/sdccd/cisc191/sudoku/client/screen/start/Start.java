...
public class Start extends BorderPane implements Screen {
    ...
    public void startScreen() {
        ...
        loadButton.setFont(Font.font(25));
        loadButton.setBackground(new Background(new BackgroundFill(Color.PALEGOLDENROD, null, null)));
        loadButton.setTranslateX(1050);
        ...
        bottomPane.setTranslateY(60);
        bottomPane.setTranslateX(5);
